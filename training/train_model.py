...
# This is the same as the train_model function above, but it expects a test set as well.
def train_model_2(model, data_dir, destination_path, batch_size, num_epochs):
    cudnn.benchmark = True
    plt.ion()   # interactive mode
...
def finetune(model_name, data_dir, destination_path, num_of_classes, batch_size=4, num_epochs=25):
    ...
    model, metrics = train_model_2(model, data_dir, destination_path, batch_size, num_epochs)
