'''
Are you trying to look through frames of a video and select some of them to save as images?

This tool lets you move through a video and save the frames you want.

Simply select the path to the video and the paths to the folders you want to save the images to.

    1. Select your video
    2. Select the folder you want to save to. If you have multiple folders:
...
under_folder = 'data_preperation/data/under'
over_folder = 'data_preperation/data/over'
normal_folder = 'data_preperation/data/normal'
