...
mouse_position = (0, 0)
crop_box_size = 50  # Size of the crop box
...
if __name__ == '__main__':
    ...
    frame = 43
    while True:
        image_path = f'/Users/brianprzezdziecki/Downloads/Bubble/Nobubble/{frame}.jpg'  # Replace this with your image path
        destination_path = f'no_bubble/frame{frame}.jpg'
